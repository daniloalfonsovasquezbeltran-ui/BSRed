...
#  - /api/salidas
#  - /api/llegadas
# Incluye ANDÉN y empresas reales citadas en la descripción.
...
# ===========================
# DATOS con empresas reales
#   Coñaripe: Buses Liquiñe / Buses Carrasco / Jet Sur
#   Villarrica: Jet Sur / JAC
#   Los Lagos: Buses Méndez
#   Rurales locales: genérico “Servicios Rurales Panguipulli”
# ===========================
BASE = [
    # -------- SALIDAS --------
    # Coñaripe
...
def normaliza_registro(h):
    """Añade sinónimos y timestamp (compatibilidad con front)."""
    reg = dict(h)
